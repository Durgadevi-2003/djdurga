...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-)atmc*yn!250m#7r7o1))m!1%bs^doenodp0hiijb^v-1z%_qx')
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Optional: if you use a /static folder
